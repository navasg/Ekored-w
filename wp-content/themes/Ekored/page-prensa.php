      ...
      <div class="container-grid">
        <div class="press-detail__content">
          <div class="post-detail__img">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/prensa/prensa.png">
          </div>
          <div class="post-detail__body">
            <div class="publications-notice__info">
              <div class="publications-notice__user">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/publicaciones/user-3@3x.png"> Andrea Miller
              </div>
              <div class="publications-notice__date">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/prensa/calendar-1@3x.png"> April 24,2019
              </div>
            </div>
